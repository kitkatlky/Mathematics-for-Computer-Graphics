...
INSTRUCTION: Build and develop an interactive Basic CG Calculator. The calculator will include all 
operations in vector such as arithmetic operations, scalar product, dot product and so on. Creativity, 
uniqueness and interactive application will score high marks. Your application must be unique. Any 
obvious similarity with others might get zero marks. The way you construct your button/menu 
arrangement must be unique and creative as well. You can add text/sound/background music/popup info 
or anything to differentiate your application.
*/
