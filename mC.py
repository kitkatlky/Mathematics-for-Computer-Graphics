...
v=IntVar()
choice_A=Radiobutton(root,text="Matrix A",variable=v,value=1,command=ChoiceA)
choice_A.configure(font=("bold",15))
choice_B=Radiobutton(root,text="Matrix B",variable=v,value=2,command=ChoiceB)
choice_B.configure(font=("bold",15))
choice_R=Radiobutton(root,text="Matrix C (Result)",variable=v,value=3)
choice_R.configure(command=ChoiceC,font=("bold",15))
